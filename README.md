...
the clean pipeline keeps high recall only by spending 25.35% FPR, over 25 times
its budget, and PR-AUC falls from 0.9811 to 0.1250. What fails first is not the
model's ranking but its calibration.
...
| Condition | Split | Clean PR-AUC | Old PR-AUC | Clean recall | Clean FPR |
|---|---|---:|---:|---:|---:|
| C3 reference | benign random, attacks random | 0.9811 | 0.9945 | 98.12% | 1.03% |
| C1 benign shift | benign **by day**, attacks random | 0.4848 | 0.7182 | 98.61% | **28.80%** |
| C2 attack shift | benign random, attacks **by day** | 0.9637 | 0.9815 | 94.25% | 0.83% |
| **C0 honest** | benign **by day**, attacks **by day** | **0.1250** | 0.2425 | 95.25% | **25.35%** |
