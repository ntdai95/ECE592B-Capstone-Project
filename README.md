...
|---|---|---|---|---|---|
| XGBoost | 0.787 | **0.996** | 0.879 | 0.84% | 0.996 |
| **Multiclass XGBoost** | 0.793 | 0.994 | 0.882 | 0.81% | 0.995 |
| Soft Voting (RF+XGB+MLP) | 0.786 | 0.993 | 0.877 | 0.85% | 0.995 |
| Random Forest | 0.782 | 0.994 | 0.876 | 0.87% | 0.993 |
| Neural Network (MLP) | 0.788 | 0.960 | 0.866 | 0.81% | 0.966 |
| Linear SVM | 0.679 | 0.506 | 0.580 | 0.75% | 0.663 |
...
PR-AUC falls from 0.994 to 0.189. What fails first is not the model's ranking but
its calibration.
...
|---|---|---|---|---|
| C3 reference | benign random, attacks random | 0.994 | 99.2% | 0.82% |
| C1 benign shift | benign **by day**, attacks random | 0.685 | 99.4% | **34.76%** |
| C2 attack shift | benign random, attacks **by day** | 0.979 | 96.9% | 0.78% |
| **C0 honest** | benign **by day**, attacks **by day** | 0.189 | 97.8% | **32.46%** |
...
|---|---|---|---|---|---|
| Random split | 0.778 | **0.996** | +0.218 | 70.5% | 99.6% |
| Session-disjoint | 0.184 | **0.189** | +0.005 | 59.3% | 97.8% |

Recall improves substantially under both regimes (+29.0 points random, +38.5
...
XGBoost). Crucially, the alert flows are normalised **once**, in
